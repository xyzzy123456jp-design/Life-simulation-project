...
DESTINATION = "/Game/Meshy_Crimson_Gaze_HeadRig_Test"
ASSET_NAME = "SK_Crimson_Gaze_HeadRig_Test"
...
if not mesh:
    raise RuntimeError("Crimson Head Rig test skeletal mesh import failed")
...
unreal.log_warning(
    f"CRIMSON_HEAD_RIG_TEST_IMPORT_DONE mesh={mesh.get_path_name()} slots={len(materials)}"
)
